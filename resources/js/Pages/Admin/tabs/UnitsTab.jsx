...
export default function UnitsTab({ units, setUnits }) {
    ...
    const handleCreateUnit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('/api/admin/units', newUnitForm, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleDeleteUnit = async (unitId) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`/api/admin/units/${unitId}`, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleUpdateUnit = async (e) => {
        ...
        try {
            const token = localStorage.getItem('token');
            const res = await axios.put(`/api/admin/units/${editingUnit.id}`, editUnitForm, {
